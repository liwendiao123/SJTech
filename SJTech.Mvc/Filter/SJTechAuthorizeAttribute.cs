...
namespace SJTech.Mvc.Filter
{
    ...
    public class SJTechAuthorizeAttribute : ActionFilterAttribute, IAuthorizationFilter
    {
        ...
        public SJTechAuthorizeAttribute()
            : this(null)
        { }

        public SJTechAuthorizeAttribute(string roleModuleName)
        {
