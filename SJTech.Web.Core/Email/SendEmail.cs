...
namespace SJTech.Core.Email
{
    using SJTech.Core.Models;
    using SJTech.Core.Config;
    ...
    public class SendEmail : ISendEmail
    {
        ...
        private string GetEmailTemplate(string body, bool usingEmailTemplate)
        {
            ...
            {
                //读取模板
                using (var srEmailTemplate = new StreamReader(Senparc.CO2NET.Utilities.ServerUtility.ContentRootMapPath("~/App_Data/Template/EmailTemplete.htm"), Encoding.UTF8))
                {
